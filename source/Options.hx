...
class MControls extends Option
{
	...
	{
		OptionsMenu.instance.openSubState(new android.CustomControlsState());
		return false;
	}

	private override function updateDisplay():String
	{
		return "Custom mobile controls";
	}
}

class Cutscene extends Option
{
	public function new(desc:String) {
		super();
		description = desc;
	...
	public override function press():Bool {
		...
		FlxG.save.data.haveCutscene = !FlxG.save.data.haveCutscene;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.haveCutscene ? "Cutscene On" : "Cutscene Off";
	}
}
...
class ResetSettings extends Option
{
	...
	public override function press():Bool
	{
		...
		FlxG.save.data.haveCutscene = null;
		#if android
		FlxG.save.data.controlMode = null;
		FlxG.save.data.vpadPositon = null;
		#end
